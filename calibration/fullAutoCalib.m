...
clear;close all;
tV = 'motor_CALIB_A0__t01_Top.avi';
fV = 'motor_CALIB_A0__t01_Front.avi';
...
%%
pause(.01)
clearvars -except tV fV viewLabel inconsistent_pairs_detection recompute* d d_front d_top d_num
...
calib_stuffz;
movefile('Calib_Results_stereo.mat',['' tV(1:end-14) 'stereoCalib.mat'])
cd ..
%%
